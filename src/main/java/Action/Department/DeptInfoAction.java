...
public class DeptInfoAction implements ActionListener{
...
//        menuPanel.add(bg);
        ...
        Neo_Button b1 = new Neo_Button("增加部门信息", new DeptInsertAction());
        b1.setBounds(25,100,150,50);
        b1.setFocusPainted(false);
        menuPanel.add(b1);

        Neo_Button b2 = new Neo_Button("删除部门信息", new DeptDeleteAction());
...
//        show_info.setBackground(Color.white);
        ...
        Neo_Button b4 = new Neo_Button("查找部门信息", new DeptSearchAction());
        b4.setBounds(550,100,150,50);
        b4.setFocusPainted(false);
        menuPanel.add(b4);

        Neo_Button b5 = new Neo_Button("修改部门信息", new DeptUpdateAction());
